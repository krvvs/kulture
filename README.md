...
### User Registration/Login: Using OAuth API by Kakao
...
### Prepaid Token Purchase: Using Payment API by Kakao
...
### Posting Image Reviews - Using FormData
